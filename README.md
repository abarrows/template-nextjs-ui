...
> :white_check_mark: Read about [Application Environment Variables](https://amuniversal.atlassian.net/wiki/spaces/DEVOps/pages/2796191745/Application+Environment+Variables) for information on how to use and edit environment variables in an application **before proceeding**.
